export const useValidator = () => {
  ...
  const isConfirmed = (value: string, confirmValue: string) => {
    console.log("PASSWORD", value, confirmValue);
    return value !== confirmValue
      ? "The input is not a valid " + value + " address"
      : "";
  };
  ...
  return { isEmpty, isNum, minLength, isEmail, isConfirmed };
};
